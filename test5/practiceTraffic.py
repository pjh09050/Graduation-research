    ...
    #def generate_routefile(self):
        ...
        with open("b.rou.xml", 'w') as routes:
            ...
            for i in range(N):
                ...
                if i % 6 == 0:
                    # W1 출발-좌회전1(N1)
                    print('    <vehicle id="LeftW1_N1_%i" type="typeCAR" route="routeW1_N1" departLane="3" depart="%i" />' % (i, i), file=routes)
                    # W1 출발-좌회전2(N2)
                    print('    <vehicle id="LeftW1_N2_%i" type="typeCAR" route="routeW1_N2" departLane="%i" depart="%i" />' % (i, a, i), file=routes)
                    # W1 출발-직진(E3)
                    print('    <vehicle id="StraightW1_E3_%i" type="typeCAR" route="routeW1_E3" departLane="%i" depart="%i" />' % (i, a, i), file=routes)
                    # W1 출발-우회전1(S1)
                    print('    <vehicle id="RightW1_S1_%i" type="typeCAR" route="routeW1_S1" departLane="0" depart="%i" />' % (i, i), file=routes)
                    # W1 출발-우회전2(S2)
                    print('    <vehicle id="RightW1_S2_%i" type="typeCAR" route="routeW1_S2" departLane="%i" depart="%i" />' % (i, b, i), file=routes)
                    # W1 출발-우회전3(S3)
                    print('    <vehicle id="RightW1_S3_%i" type="typeCAR" route="routeW1_S3" departLane="%i" depart="%i" />' % (i, b, i), file=routes)
                    ...
                    # E3 출발-좌회전2(S3)
                    print('    <vehicle id="LeftE3_S2_%i" type="typeCAR" route="routeE3_S2" departLane="%i" depart="%i" />' % (i, a, i), file=routes)
                    # E3 출발-좌회전3(S1)
                    print('    <vehicle id="LefttE3_S1_%i" type="typeCAR" route="routeE3_S1" departLane="%i" depart="%i" />' % (i, a, i), file=routes)
                    # E3 출발-직진(W1)
                    ...
                    # E3 출발-우회전2(N2)
                    print('    <vehicle id="RightE3_N2_%i" type="typeCAR" route="routeE3_N2" departLane="%i" depart="%i" />' % (i, b, i), file=routes)
                    # E3 출발-우회전3(N1)    
                    print('    <vehicle id="RightE3_N1_%i" type="typeCAR" route="routeE3_N1" departLane="%i" depart="%i" />' % (i, b, i), file=routes)
