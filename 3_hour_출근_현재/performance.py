...
def calculate_target_index():
    ...
    right_left = ['03to0000_0','03to0000_1','03to0000_2','03to0000_3', '0000toc3_0','0000toc3_1','0000toc3_2', 'c3to000_0','c3to000_1','c3to000_2','c3to000_3', '000toc2_0','000toc2_1', '000toc2_2','c2to00_0','c2to00_1','c2to00_2','c2to00_3','00to01_0','00to01_1','00to01_2']

    left_right = ['02to00_0','02to00_1','02to00_2','02to00_3','00toc1_0','00toc1_1','00toc1_2','c1to000_0','c1to000_1','c1to000_2','c1to000_3','000toc4_1','000toc4_2','000toc4_3','c4to0000_0','c4to0000_1','c4to0000_2','c4to0000_3', '0000to04_1','0000to04_2','0000to04_3']
    ...
    weighted_waiting_times = (all_left_right_ratio * sum(all_left_right_waiting_times)) + ((1 - all_left_right_ratio) * sum(up_down_waiting_times))
    total_lanes = len(all_left_right) + len(up_down)
    ...
    return average_waiting_time, average_right_left_waiting_time, average_left_right_waiting_time