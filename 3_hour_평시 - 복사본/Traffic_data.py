...
def total_traffic():
    ...
    for i, interval in enumerate(E3_arrival_intervals):
        car_direction = random.choices(population=["routeE3_W1", "routeE3_N1", "routeE3_S1", "routeE3_N2", "routeE3_S2", "routeE3_N3", "routeE3_S3"], weights=[0.49, 0.04, 0.08, 0.06, 0.05, 0.1, 0.18], k=1)[0]
