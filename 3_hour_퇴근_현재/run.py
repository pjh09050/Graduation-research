...
#####################################################################################################################################################################################
    ...
    while run_step < 10:
        ...
        # sumo 시뮬레이션  성능 추출하는 부분
        average_waiting_time_list2, all_direction_average2, left_right_list_average2, max_waiting_time2, right_left_list_average2, left_right_waiting_time2, up_down_list_average2, down_up_list_average2 = run()
        ...
        up_down_result2.append(up_down_list_average2)
        down_up_result2.append(down_up_list_average2)
