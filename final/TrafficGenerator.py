...
class TrafficGenerator:
    ...
    #def generate_routefile(self):
        ...
        with open("b.rou.xml", 'w') as routes:
            print("""<routes>
            <vType id="typeCAR" length="4" minGap="2" maxSpeed="10" allowLaneChange="False" guiShape="passenger"/>
            ...
            for i in range(N):
                ...
                print('    <vehicle id="RightW1_N1_%i" type="typeCAR" route="routeW1_N1" departLane="3" depart="%i" color="%i, %i, %i"/>' % (i, 3.4, color[0], color[1], color[2]), file=routes)
                ...
                # print('    <vehicle id="StraightW1_S2_%i" type="typeCAR" route="routeW1_S2" departLane="%i" depart="%i" />' % (i, a, i), file=routes)
                # print('    <vehicle id="StraightW1_S3_%i" type="typeCAR" route="routeW1_S3" departLane="%i" depart="%i" />' % (i, a, i), file=routes)
                ...
                # print('    <vehicle id="StraightN1_S1_%i" type="typeCAR" route="routeN1_S1" departLane="%i" depart="%i" />' % (i, a, i), file=routes)
                # print('    <vehicle id="LeftN1_E3_%i" type="typeCAR" route="routeN1_E3" departLane="3" arrivalLane="%i" depart="%i" />' % (i, b, i), file=routes) 
                # print('    <vehicle id="LeftN1_S2_%i" type="typeCAR" route="routeN1_S2" departLane="3"  depart="%i" />' % (i, i), file=routes)
                # print('    <vehicle id="LeftN1_S3_%i" type="typeCAR" route="routeN1_S3" departLane="3"  depart="%i" />' % (i, i), file=routes)
                ...
                # print('    <vehicle id="StraightN3_S3_%i" type="typeCAR" route="routeN3_S3" departLane="%i" depart="%i" />' % (i, e, i), file=routes)
                ...
                # print('    <vehicle id="StraightS3_N3_%i" type="typeCAR" route="routeS3_N3" departLane="%i" depart="%i" />' % (i, e, i), file=routes)
