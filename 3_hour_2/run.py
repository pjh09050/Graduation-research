...
def main():
    ...
    # current_phases2 = [60, 3, 18, 4, 3, 22, 3, 61, 3, 3]

    # PSO best
    # current_phases0 = [24, 3, 24, 3, 23, 3, 48, 3, 46, 3]
    # current_phases1 = [23, 3, 22, 3, 27, 3, 22, 3, 71, 3]
    # current_phases2 = [56, 3, 14, 1, 3, 29, 3, 65, 3, 3]

    # pso 횡단보도
    # current_phases0 = [28, 3, 16, 3, 30, 3, 48, 3, 43, 3]
    # current_phases1 = [36, 3, 13, 3, 21, 3, 40, 3, 55, 3]
    # current_phases2 = [55, 3, 21, 1, 3, 24, 3, 64, 3, 3]
