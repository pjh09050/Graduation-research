...
def generate_routefile():
    ...
    with open("final.rou.xml", 'w') as routes:
        print("""<routes>
        <vType id="typeCAR" length="5" minGap="2.5" maxSpeed="10" arrivalLaneChange="True" guiShape="passenger"/>

        <route id='routeW1_N1' edges='02to00 00to2'/>
        <route id='routeW1_S1' edges='02to00 00to3'/>
        <route id='routeW1_N2' edges='02to00 00to009 009to000 000to6'/>
        <route id='routeW1_S2' edges='02to00 00to000 000to7'/>
        <route id='routeW1_S3' edges='02to00 00to000 000to015 015to0000 0000to11'/>
        ...
        <route id='routeN1_S3' edges='1to00 00to000 000to015 015to0000 0000to11'/>
        ...
        <route id='routeS1_S3' edges='4to00 00to000 000to015 015to0000 0000to11'/>
        <route id='routeS1_E3' edges='4to00 00to000 000to0000 0000to04'/>
        
        <route id='routeN2_W1' edges='5to000 000to00 00to01'/>
        <route id='routeN2_S1' edges='5to000 000to011 011to00 00to3 '/>
        <route id='routeN2_S2' edges='5to000 000to7'/>
        <route id='routeN2_S3' edges='5to000 000to015 015to0000 0000to11'/>
        ...
        <route id='routeS2_S3' edges='8to000 000to015 015to0000 0000to11'/>
        ...
        <route id='routeN3_S1' edges='9to0000 0000to000 000to011 011to00 00to3'/>
        <route id='routeN3_S2' edges='9to0000 0000to013 013to000 000to7'/>
        ...
        <route id='routeS3_S1' edges='12to0000 0000to000 000to011 011to00 00to3'/>
        ...
        <route id='routeE3_S1' edges='03to0000 0000to000 000to011 011to00 00to3'/>
        <route id='routeE3_N2' edges='03to0000 0000to000 000to6'/>
        <route id='routeE3_S2' edges='03to0000 0000to013 013to000 000to7'/>
